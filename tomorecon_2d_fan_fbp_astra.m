function [ recon ] = tomorecon_2d_fan_fbp_astra(CtData, xDim, yDim, varargin)
%TOMORECON_2D_FAN_FBP_ASTRA Analytical 2D fan-beam reconstruction.
%   recon = tomorecon_2d_fan_fbp_astra(CtData, xDim, yDim) computes 
...
%
%   recon = tomorecon_2d_fan_fbp_astra(CtData, xDim, yDim, energyBin)
...
%   path.  The reconstruction is computed using the CPU. The function has 
%   been verified to work with ASTRA version 1.8.0.
%
%   NOTE: The CPU-based FBP algorithm in ASTRA Tomography Toolbox does not 
%   properly support fan-beam geometry. If possible, use the function 
%   TOMORECON_2D_FAN_FBP_ASTRA_CUDA instead.
%
%   NOTE: This function has encountered instability issues with ASTRA 
%   version 1.8.3 and ones newer than that. It is recommended to use the 
%   function TOMORECON_2D_FAN_FBP_ASTRA_CUDA instead, if possible.
%
